...
import { OVERLAY_TOAST_LAYER_CLASS } from "@/components/ui/overlay-layers";
...
>(({ className, ...props }, ref) => (
  <ToastPrimitives.Title ref={ref} className={cn("text-sm font-semibold break-words [overflow-wrap:anywhere]", className)} {...props} />
));
ToastTitle.displayName = ToastPrimitives.Title.displayName;

/**
 * 内部组件：`ToastDescription`。
 *
 * @remarks
 * 用于拆分当前文件中的局部界面结构或交互片段，减少主组件体积并收拢视图职责。
 */
...
>(({ className, ...props }, ref) => (
  <ToastPrimitives.Description ref={ref} className={cn("text-sm opacity-90 whitespace-pre-wrap break-words [overflow-wrap:anywhere]", className)} {...props} />
));
